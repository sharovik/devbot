...
insert into main.events (id, alias, installed_version) values (3, 'themer_wordpress_event', null);
insert into main.events (id, alias, installed_version) values (4, 'hello', null);

insert into main.questions (id, question, answer, scenario_id, regex_id) values (1, 'Help', 'Here what I can', 1, 1);
...
insert into main.questions (id, question, answer, scenario_id, regex_id) values (3, 'Process', 'Ok, please wait a sec', 3, 3);
...
insert into main.questions_regex (id, regex, regex_group) values (1, '(?i)help', '');
insert into main.questions_regex (id, regex, regex_group) values (2, '(?i)(New answer)', '');
insert into main.questions_regex (id, regex, regex_group) values (3, '(?i)process', '');
...
insert into main.scenarios (id, name, event_id) values (1, 'Scenario #1', 1);
insert into main.scenarios (id, name, event_id) values (2, 'Scenario #2', 2);
insert into main.scenarios (id, name, event_id) values (3, 'Scenario #3', 3);
